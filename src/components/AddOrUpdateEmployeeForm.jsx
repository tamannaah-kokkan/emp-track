      ...
      <form onSubmit={handleSubmit} className="p-6 bg-slate-200 w-full rounded-lg shadow-lg">
        ...
        <input
          ...
          className={`w-full border p-2 mb-4 rounded ${
            errors.first_name ? 'border-red-500 bg-red-50' : 'border-cyan-800'
          }`}/>
        ...
        <input
          ...
          onChange={handleChange}
          className={`w-full border p-2 mb-4 rounded ${
            errors.last_name ? 'border-red-500 bg-red-50' : 'border-cyan-800'
          }`}/>
        ...
        <input
          ...
          onChange={handleChange}
          className={`w-full border p-2 mb-4 rounded ${
            errors.email_id ? 'border-red-500 bg-red-50' : 'border-cyan-800'
          }`}/>
